...
function setFavoriteRestaurent1(){
 ...
 // setGestureRecogniserToFrmfav();
  ...
  for(var i=0;i<favList.length;i++){
    resObj={
      "imgResIcon":{"src":response["results"][favList[i]]["icon"]},
      "lblResName":{"text":response["results"][favList[i]]["name"]},
	...
	//	var animConf = getAnimationConfig();
      var animConf =    { 
		...
		var swipeAnimtion1 = { definition : animObj,
					config : animConf,
					callbacks : null};
      var jsonObj={rows:rowList, widgets : ["fcResDetails"], animation: swipeAnimtion1};
